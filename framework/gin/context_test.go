...
import (
	...
	testdata "github.com/baizetianxia/coreWeb/framework/gin/testdata/protoexample"
)
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/baizetianxia/coreWeb/framework/gin.handlerNameTest$", c.HandlerName())
}
